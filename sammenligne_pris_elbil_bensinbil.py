...
# Pris pr. år
arlig_kostnad_el = forsikring_el + trafikkforsikringsavgift + drivstoffbruk_el + bom_el # [kr]
arlig_kostnad_bensin = forsikring_bensin + trafikkforsikringsavgift + drivstoffbruk_bensin + bom_bensin  # [kr]
